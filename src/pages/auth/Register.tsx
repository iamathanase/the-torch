...
import { Loader2, ArrowRight, Mail, Lock, User, Phone, ArrowLeft } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 flex items-center justify-center p-4">
      ...
      {/* Centered Container */}
      <div className="w-full max-w-5xl max-h-[90vh] bg-white rounded-2xl shadow-2xl overflow-hidden flex">
            ...
            <div className="space-y-4 text-left max-w-md mx-auto">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-100">Farmer, Vendor, Customer, or Gardener</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-400 flex items-center justify-center mt-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-100">Complete your information to get started</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-400 flex items-center justify-center mt-1">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-100">Buy, sell, learn, and grow together</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Doe"
                  className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent bg-slate-50"
                  disabled={loading}
                />
              </div>
            </div>
